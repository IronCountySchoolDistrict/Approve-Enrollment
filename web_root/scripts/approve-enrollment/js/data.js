    define(function() {
        ...
        return {
            ...
            getFormData: function() {
                ...
                return $j.when.apply($j, requests).then(function(enrollment, fieldMap, studentIds) {
                    ...
                    return self.getCoreStudentData(studentIds).then(function(studentCoreData) {
                        ...
                        return $j.getJSON("/admin/approve-enrollment/json/approve-fields.json?" + gpvParam, function(fields) {
                            ...
                            $j.each(fields, function(index, field) {
                                ...
                                if (field.hasOwnProperty('addressFieldValue')) {
                                    field = self.cleanAddressFields(field);
                                }

                                if (field.fieldName === "race") {
                                    field = self.cleanRaceField(field);
                                }
                                formData.push(field);
            ...
            cleanRaceField: function(field) {
                ...
                if (field.fieldValue.indexOf(whiteValue) > -1) {
                    cleanValue.push("White");
                }
                if (field.fieldValue.indexOf(aiValue) > -1) {
                    cleanValue.push("American Indian");
                }
                if (field.fieldValue.indexOf(asianValue) > -1) {
                    cleanValue.push("Asian");
                }
                if (field.fieldValue.indexOf(blackValue) > -1) {
