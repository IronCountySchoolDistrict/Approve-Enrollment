...
define(['jquery'], function ($) {
    ...
    return {
        ...
        saveHandler: function (target, _this) {
            ...
            $.each($fieldValueElems, function (key, elem) {
                var corresEditSelector = $(elem).data().editElem;

                $(elem).text(_this.fieldToString($(corresEditSelector)));
            });
        ...
        bindEditHandler: function () {
            ...
            $(document).on("click", ".glyphicon-edit", function (e) {
                ...
                $.each($fieldValueElems, function (key, elem) {
                    ...
                    var corresEditElems = $(corresEditSelector);
                    ...
                    if (editType === "radio" || editType === "checkbox") {
                        ...
                        // the edit element.
                        $(corresEditSelector).val($(elem).text());
                    }
                });
