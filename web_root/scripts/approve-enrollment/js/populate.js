...
define(['underscore'], function (_) {
    ...
    return {
        ...
        populateStaging: function (stagingData) {
            ...
            $j('#med-diabetes-field-value').html(stagingData.medDiabetes ? "Yes" : "No");
            $j('#med-heart-field-value').html(stagingData.medHeart ? "Yes" : "No");
            $j('#med-seizures-field-value').html(stagingData.medSeizures ? "Yes" : "No");
            $j('#med-add-adhd-field-value').html(stagingData.medAddAdhd ? "Yes" : "No");
            $j('#med-hearing-field-value').html(stagingData.medHearing ? "Yes" : "No");
            $j('#med-vision-field-value').html(stagingData.medVision ? "Yes" : "No");
            $j('#med-glasses-field-value').html(stagingData.medGlasses ? "Yes" : "No");
            $j('#med-asthma-field-value').html(stagingData.medAsthma ? "Yes" : "No");
            $j('#med-allergies-field-value').html(stagingData.medAllergies ? "Yes" : "No");
            $j('#med-require-meds-field-value').html(stagingData.medRequireMeds ? "Yes" : "No");
            $j('#medications-field-value').html(stagingData.medications);
            $j('#med-other-field-value').html(stagingData.medOther ? "Yes" : "No");
            $j('#add-med-services-field-value').html(stagingData.addMedServices);

            $j('#physicians-name-field-value').html(stagingData.physiciansName);
            $j('#physicians-phone-field-value').html(stagingData.physiciansPhone);
            $j('#dentists-name-field-value').html(stagingData.dentistsName);
            $j('#dentists-phone-field-value').html(stagingData.dentistsPhone);
            $j('#medical-release-field-value').html(stagingData.medicalRelease ? "Yes" : "No");
            $j('#field-trips-field-value').html(stagingData.fieldTrips ? "Yes" : "No");
            $j('#media-full-name-field-value').html(stagingData.mediaFullName ? "Yes" : "No");
            $j('#policy-aup-field-value').html(stagingData.policyAup);
            $j('#policy-safe-schools-field-value').html(stagingData.policySafeSchools);
        }
    }
});