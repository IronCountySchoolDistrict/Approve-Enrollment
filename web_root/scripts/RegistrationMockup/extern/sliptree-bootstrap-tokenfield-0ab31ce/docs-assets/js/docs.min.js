...
jQuery(function () {
    ...
    }, 100), a(".token-example-field").tokenfield(), a("#tokenfield-1").tokenfield({autocomplete: {source: ["red", "blue", "green", "yellow", "violet", "brown", "purple", "black", "white"], delay: 100}, showAutocompleteOnFocus: !0, delimiter: [",", " ", "-", "_"]});
    var b = new Bloodhound({local: [
        {value: "red"},
        {value: "blue"},
        {value: "green"},
        {value: "yellow"},
    ...
    b.initialize(), a("#tokenfield-typeahead").tokenfield({typeahead: {source: b.ttAdapter()}}), a("#tokenfield-2").on("tokenfield:preparetoken", function (a) {
