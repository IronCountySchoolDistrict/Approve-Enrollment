...
!function (a) {
    ...
    var c = function (c, d) {
        ...
        if (p.length && p.prop("for", this.$input.prop("id")), this.$copyHelper = a('<input type="text" />').css("position", "absolute").css(m, "-10000px").prop("tabindex", -1).prependTo(this.$wrapper), k ? this.$wrapper.css("width", k) : i ? this.$wrapper.css("width", i) : this.$element.parents(".form-inline").length && this.$wrapper.width(l), (this.$element.prop("disabled") || this.$element.parents("fieldset[disabled]").length) && this.disable(), this.$mirror = a('<span style="position:absolute; top:-999px; left:0; white-space:pre;"/>'), this.$input.css("min-width", this.options.minWidth + "px"), a.each(["fontFamily", "fontSize", "fontWeight", "fontStyle", "letterSpacing", "textTransform", "wordSpacing", "textIndent"], function (a, b) {
            ...
            var q = "rtl" === this.textDirection ? "right" : "left", r = a.extend({minLength: this.options.showAutocompleteOnFocus ? 0 : null, position: {my: q + " top", at: q + " bottom", of: this.$wrapper}}, this.options.autocomplete);
            this.$input.autocomplete(r)
        }
        if (!a.isEmptyObject(this.options.typeahead)) {
            var s = a.extend({minLength: this.options.showAutocompleteOnFocus ? 0 : null}, this.options.typeahead);
            this.$input.typeahead(null, s), this.typeahead = !0
        }
        this.$element.trigger("tokenfield:initialize")
    };
    c.prototype = {constructor: c, createToken: function (b, c) {
        "string" == typeof b && (b = {value: b, label: b}), "undefined" == typeof c && (c = !0);
        var d = this, e = a.trim(b.value), f = b.label && b.label.length ? a.trim(b.label) : e;
        if (!(!e.length || !f.length || e.length < this.options.minLength || this.options.limit && this.getTokens().length >= this.options.limit)) {
            ...
            if (g.token = {value: e, label: f}, this.$element.trigger(g), g.token) {
                if (e = g.token.value, f = g.token.label, !this.options.allowDuplicates && a.grep(this.getTokens(), function (a) {
                    ...
                    h.token = {value: e, label: f}, this.$element.trigger(h);
                ...
                var k = j.find(".token-label"), l = j.find(".close");
        ...
        var c = b.map(function () {
            var b = a(this);
            return{value: b.attr("data-value"), label: b.find(".token-label").text()}
        }).get();
        ...
        if (b) {
            var c = b.data("value"), d = b.find(".token-label").text(), e = a.Event("tokenfield:edittoken");
            if (e.token = {value: c, label: d}, e.relatedTarget = b.get(0), this.$element.trigger(e), e.token) {
    ...
    }, a.fn.tokenfield.defaults = {minWidth: 60, minLength: 0, allowDuplicates: !1, allowEditing: !0, limit: 0, autocomplete: {}, typeahead: {}, showAutocompleteOnFocus: !1, createTokensOnBlur: !1, delimiter: ",", beautify: !0}, a.fn.tokenfield.Constructor = c, a.fn.tokenfield.noConflict = function () {
